...
exports.default = (function (inputPaths_1) {
    var args_1 = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        args_1[_i - 1] = arguments[_i];
    }
    return __awaiter(void 0, __spreadArray([inputPaths_1], args_1, true), void 0, function (inputPaths, exclude) {
        var files, pkgEntities, _loop_1, _a, files_1, file, _b, _c, f;
        var _d;
            ...
            switch (_e.label) {
                ...
                case 1:
                    ...
                    _loop_1 = function (file) {
                        var pkg, _f, _g, e_1, pkgEntity, fileEntity;
                        return __generator(this, function (_h) {
                            switch (_h.label) {
                                ...
                                case 5:
                                    ...
                                    fileEntity = (0, data_1.recordEntityFile)(new naming_1.default('File', file.name), file.fullname, file.ext.includes('m') || file.ext.includes('t') ? 'module' : (((_d = pkgEntity === null || pkgEntity === void 0 ? void 0 : pkgEntity.pkgJson) === null || _d === void 0 ? void 0 : _d.type) === 'module' ? 'module' : 'script'), file.ext === 'json' ? 'json' : (file.ext.includes('ts') ? 'ts' : 'js'), file.ext.includes('x'), 
